    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Button asChild variant="outline" className="h-16 flex-col space-y-2">
            <Link href="/dashboard/panel-layout">
              <div className="text-2xl">🔧</div>
              <span className="text-sm">Panel Layout Designer</span>
            </Link>
          </Button>
          
          <Button asChild variant="outline" className="h-16 flex-col space-y-2">
            <Link href="/dashboard/qc-data">
              <div className="text-2xl">📈</div>
              <span className="text-sm">Upload QC Data</span>
            </Link>
          </Button>
