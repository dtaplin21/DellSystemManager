      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogTrigger asChild>
            <Button className="bg-[#0052cc] hover:bg-[#003d99] text-white">
        ...
        <Card className="bg-white border-none shadow-sm">
          <CardContent className="p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="w-10 h-10 rounded-lg bg-[#36b37e] flex items-center justify-center text-white">
                ▶️
              </div>
            </div>
        ...
        <Card className="bg-white border-none shadow-sm">
          <CardContent className="p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="w-10 h-10 rounded-lg bg-[#00857c] flex items-center justify-center text-white">
                ✅
              </div>
            </div>
            <div className="text-3xl font-bold text-[#172b4d]">
        ...
        <Card className="bg-white border-none shadow-sm">
          <CardContent className="p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="w-10 h-10 rounded-lg bg-[#ff5630] flex items-center justify-center text-white">
                ⚠️
              </div>
            </div>
            <div className="text-3xl font-bold text-[#172b4d]">
        ...
        <CardHeader className="border-b border-[#dfe1e6]">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              <Button variant="outline" className="text-[#6b778c] border-[#dfe1e6]">
