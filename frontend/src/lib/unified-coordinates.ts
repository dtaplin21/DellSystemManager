...
// Core configuration
export const PIXELS_PER_FOOT = 2; // 2 pixels = 1 foot (configurable)
export const GRID_SIZE_PIXELS = 20; // 20px = 10 feet
export const MAJOR_GRID_INTERVAL = 5; // Every 5 grid lines = 50 feet

// Grid configuration
export const GRID_CONFIG = {
  minorSpacing: GRID_SIZE_PIXELS, // 20px = 10 feet
  majorSpacing: GRID_SIZE_PIXELS * MAJOR_GRID_INTERVAL, // 100px = 50 feet
  minorColor: '#e5e7eb',
  majorColor: '#d1d5db',
  lineWidth: 1
} as const;
